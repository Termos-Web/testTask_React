export const FavoriteCarIcon = () => {
    return (
        <svg className="car-card__favorite-logo" width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_4451_143)">
